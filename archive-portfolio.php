...
// $image_size = $pf_list_view == 'columns' ? 'boldthemes_large_square' : 'boldthemes_large_rectangle';
$image_size = 'large';
		...
		<article class="btNoSearchResults bt_bb_section bt_bb_top_spacing_large bt_bb_bottom_spacing_large bt_bb_layout_boxed_1200">
			<div class="bt_bb_port">
				...
				echo boldthemes_get_heading_html(
					array(
						'headline' => esc_html__( 'We are sorry, no results for: ', 'squadrone' ) . get_search_query(),
						'subheadline' => esc_html__( 'Back to homepage', 'squadrone' ),
						'url' => site_url(),
						'size' => 'medium'
					)									 
				);
