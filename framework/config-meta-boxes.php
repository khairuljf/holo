...
boldthemes_add_mb( array( 'id' => 'page', 'title' => esc_html__( 'Settings', 'squadrone' ), 'post_type' => 'page', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'menu_name',
		'name'     => esc_html__( 'Custom Primary Menu Name', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Footer Menu Name', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'override',
		'name'     => esc_html__( 'Override Global Settings', 'squadrone' ),
		'type'     => 'boldthemestext',
		'clone'    => true
	)
);
...
boldthemes_add_mb( array( 'id' => 'post', 'title' => esc_html__( 'Settings', 'squadrone' ), 'post_type' => 'post', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'menu_name',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Meta Description', 'squadrone' ),
		'type'     => 'textarea'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'images',
		'name'     => esc_html__( 'Images', 'squadrone' ),
		'type'     => 'image_advanced'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Grid Gallery', 'squadrone' ),
		'type'     => 'checkbox'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'video',
		'name'     => esc_html__( 'Video', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'audio',
		'name'     => esc_html__( 'Audio', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_title',
		'name'     => esc_html__( 'Link', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_url',
		'name'     => esc_html__( 'Link URL', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'quote',
		'name'     => esc_html__( 'Quote', 'squadrone' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Quote Author', 'squadrone' ),
		'type'     => 'text'
	)
);
...
boldthemes_add_mb( array( 'id' => 'portfolio', 'title' => esc_html__( 'Settings', 'squadrone' ), 'post_type' => 'portfolio', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'portfolio',
		'field_id' => 'description',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Fields', 'squadrone' ),
...
boldthemes_add_mb( array( 'id' => 'product', 'title' => esc_html__( 'Settings', 'squadrone' ), 'post_type' => 'product', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'product',
		'field_id' => 'override',
