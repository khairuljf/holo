			...
			echo '<div class="btArticleContentHolder">';
				...
				echo '<div class="btArticleShareEtc">';
					...
					echo '<div class="btReadMoreColumn">';
						...
						echo boldthemes_get_button_html( array ( 'icon' => $continue_icon, 'url' => get_permalink(), 'text' => esc_html__( 'CONTINUE READING', 'squadrone' ), 'style' => 'outline', 'size' => 'small', 'icon_position' => $continue_icon_position ) );
					echo '</div><!-- /btTags -->';
