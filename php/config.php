...
if ( ! function_exists( 'squadrone_color_schemes' ) ) {
	function squadrone_color_schemes( $color_scheme_arr ) {

		$theme_color_schemes = array();
		$theme_color_schemes[] = 'dark-skin;Light font, dark background;#ffffff;#262626';
		$theme_color_schemes[] = 'light-skin;Dark font, light background;#262626;#ffffff';
		...
		$theme_color_schemes[] = 'gray-background;Dark font, gray background;#444;#efefef';
		$theme_color_schemes[] = 'dark-gray-background;Light font, dark gray background;#efefef;#333333';
